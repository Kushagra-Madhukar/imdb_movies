...
const Login = () => {
    ...
    async function submitHandler(e){
        e.preventDefault()
        try{
            let loginResponse = await axios.post(`${BACKEND_URL}/login/jwt`, {username: username, password: password}, {withCredentials: true})
            ...
            <SignWholeContainer>
                ...
                <SignContainer>
                    <SignHolder onSubmit={submitHandler}>
                        ...
                        <SignSubmitButton type="submit">Login</SignSubmitButton>
                    </SignHolder>
                </SignContainer>
                <SignBottomContainer>
                    <OtherPageLink>
                        <OtherPageText>Don't have an account?</OtherPageText>
                        <PageLink to='/Register'>Create account</PageLink>
                    </OtherPageLink>
                </SignBottomContainer>
            </SignWholeContainer>
        </SignBackground>
